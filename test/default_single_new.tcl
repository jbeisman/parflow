...
#-----------------------------------------------------------------------------
pfrun default_single_new
pfundist default_single_new

# To run with debugging
# pfrun default_single_new -g {0 1}
...
if ![pftestFile default_single_new.out.press.00000.pfb "Max difference in Pressure" $sig_digits] {
    set passed 0
}

if ![pftestFile default_single_new.out.perm_x.pfb "Max difference in perm_x" $sig_digits] {
    set passed 0
}
if ![pftestFile default_single_new.out.perm_y.pfb "Max difference in perm_y" $sig_digits] {
    set passed 0
}
if ![pftestFile default_single_new.out.perm_z.pfb "Max difference in perm_z" $sig_digits] {
    set passed 0
}

foreach i "00000 00001 00002 00003 00004 00005" {
    if ![pftestFile default_single_new.out.concen.0.00.$i.pfsb "Max difference in concen timestep $i" $sig_digits] {
    set passed 0
    }
}

if $passed {
    puts "default_single_new : PASSED"
} {
    puts "default_single_new : FAILED"
}
