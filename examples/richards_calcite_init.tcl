...
#pfset ICPressure.GeomNames                              domain
#pfset Geom.domain.ICPressure.FileName richards_calcite_restart.out.press.00004.pfb
...
pfset Chemistry.ParFlowTimeUnits yr
...
# -1 will not write restart files
#pfset Chemistry.RestartFileWriteInterval -1
pfset Chemistry.RestartFileWriteInterval 2

# restart from file? 
pfset Chemistry.RestartFromFile False

# restart filename -- only used if Chemistry.RestartFromFile is True
#pfset Chemistry.RestartFileName "richards_calcite_restart.out.CHEM_CHKPT.00004.pfb"
...
#pfdist richards_calcite_wpress.out.press.00006.pfb
#pfdist richards_calcite_wpress.out.CHEM_CHKPT.00006.pfb

pfrun richards_calcite_init
pfundist richards_calcite_init
